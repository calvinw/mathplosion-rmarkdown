...
The code block shows we can run R code. Cars is one of the built in data sets in R, so we just show that we can print out some descriptive statistics about the data set:   
